...
BACKGROUND_COLOR: tuple[int, int, int] = (220, 220, 220)  # The background color of the window
...
TRACE_COLOR: tuple[int, int, int] = (135, 206, 250)  # The color of a trace left by a pedestrian
...
SPEED_TABLE: dict[int, float] = { 0: 1.2, 1: 1.4, 2: 1.6, 3: 1.55, 4: 1.52, 5: 1.5, 6: 1.47, 
                                 7: 1.45, 8: 1.4, 9:1.3, 10: 1.25, 11: 1.2, 12: 1.1, 13: 0.9, 14: 0.7}